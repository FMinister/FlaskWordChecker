...
def check_english(list):
    with open("/home/LassMalMachen/FlaskWordChecker/src/words_english.txt", "r") as words:
...
def check_german(list):
    with open("/home/LassMalMachen/FlaskWordChecker/src/words_german.txt", "r") as words:
        solution = check_words(list, words)
        if len(solution) == 0:
